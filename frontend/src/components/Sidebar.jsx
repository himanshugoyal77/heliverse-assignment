...
const Sidebar = () => {
  ...
  return (
    <div className="basis-44 bg-[#1E212A] text-white h-full py-5 px-2">
      ...
      <div
        className={`flex gap-2 mt-8 px-1 items-center cursor-pointer ${
      ...
      <div
        className={`flex gap-2 mt-3 px-1 items-center cursor-pointer ${
